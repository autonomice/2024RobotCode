...
import github.autonomice.util.rr.messages.DriveCommandMessage;
...
public final class MecanumDrive extends SubsystemBase {
    public static Constants.MecanumDriveParams PARAMS = new Constants.MecanumDriveParams();
    ...
    public static class DefaultCommand extends CommandBase {
        ...
        public DefaultCommand(MecanumDrive mecanumDrive, GamepadEx gamepad) {
